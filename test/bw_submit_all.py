...
def main():
    ...
    config.General.workArea = 'Y2bwWorkArea'
    config.General.transferLogs = True

    config.section_("JobType")
    config.JobType.pluginName = 'Analysis'
    config.JobType.psetName = 'SingleLepAna_crab_cfg.py' 
    config.JobType.pyCfgParams = ['isData=False','doPUReweightingOfficial=True' , 'applyTopPtCorr=False','jecShift=0','jerShift=-1'] 
    ...
    config.Data.outLFNDirBase = '/store/group/phys_b2g/skhi/SingleLepBW/'
